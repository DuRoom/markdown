...
import BasicEditorDriver from 'duroom/common/utils/BasicEditorDriver';
import styleSelectedText from 'duroom/common/utils/styleSelectedText';
...
function markdownToolbarItems(oldFunc) {
  ...
  function tooltip(name, hotkey) {
    return app.translator.trans(`duroom-markdown.forum.composer.${name}_tooltip`) + (hotkey ? ` <${modifierKey}-${hotkey}>` : '');
  }
...
app.initializers.add('duroom-markdown', function (app) {
